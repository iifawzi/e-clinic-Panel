...
export const actions = {
  getDoctorSlots({ commit }, doctor_id) {
    ...
    commit("setSlots", "");
    this.$axios
      .post("/controlPanel/getDoctorSlots", { doctor_id }, config)
      .then(response => {
  ...
  addNewSlot({ commit, dispatch }, data) {
    ...
    this.$axios
      .post("/slots/addSlot", { ...data }, config)
      .then(response => {
  ...
  updateSlot({ commit, dispatch }, { newData, doctor_id }) {
    ...
    this.$axios
      .patch("/slots/updateSlot", { ...newData }, config)
      .then(response => {
  ...
  getOpenSlots({ commit }, data) {
    ...
    this.$axios
      .post("/slots/getOpenSlots", data, config)
      .then(response => {
